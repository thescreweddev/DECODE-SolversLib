...
@Autonomous(name = "aicLV", group = "1")
public class AutoLEAVE extends CommandOpMode {
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    private final Pose start = new Pose(65,8.35,Math.toRadians(90));   //start
    private final Pose preload = new Pose(65,17);    //preload
    private final Pose path2 = new Pose(65,31);       // go to first  stack
...
//    private final Pose test2 = new Pose(112.5, 102);
    ...
    public void buildPaths() {
        ...
        scorePreload.setLinearHeadingInterpolation(start.getHeading(), Math.toRadians(118));

        firststack = new Path(new BezierLine(preload,path2));
        firststack.setLinearHeadingInterpolation(Math.toRadians(118),Math.toRadians(90));
...
//                        new InstantCommand(()-> baller.autoDetection(false)),
                        ...
                        new InstantCommand(()-> shooter.shoot(0.98)),
                        new WaitCommand(500),
                        new InstantCommand(()-> shooter.shoot(0.98)),
